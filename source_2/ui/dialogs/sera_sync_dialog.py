...
class SeraSyncDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        desc = QLabel(
            ...
            "Click 'Sync Selected' or 'Sync To All Devices' to push your database to team members."
        )
        ...
        log_top = QHBoxLayout()
        log_info = QLabel("Real-time P2P sync events, guards & log transfers:")
    ...
    def _add_log_item(self, ts: str, cat: str, message: str):
        ...
        formatted_text = f"[{ts}] {icon_badge} {cat_upper:^8} | {message}"
