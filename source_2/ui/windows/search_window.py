            ...
            for r, client in enumerate(clients):
                ...
                for c_idx, col in enumerate(mcl_cols):
                    ...
                    if fmt:
                        font = item.font()
                        if fmt.get("bg_color"):
                            item.setBackground(QColor(fmt["bg_color"]))
                            font.setBold(True)
                        if fmt.get("fg_color"):
                            item.setForeground(QColor(fmt["fg_color"]))
                            font.setBold(True)
                        item.setFont(font)
                ...
                if svc_fmt:
                    ...
                    if svc_fmt.get("bg_color"):
                        svc_item.setBackground(QColor(svc_fmt["bg_color"]))
                        font.setBold(True)
                    if svc_fmt.get("fg_color"):
                        svc_item.setForeground(QColor(svc_fmt["fg_color"]))
                        font.setBold(True)
