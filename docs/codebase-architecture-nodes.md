...
graph TD
    ...
    subgraph Main Windows
        SEARCH["ui/windows/search_window.py<br/><i>(Client Search & Grid)</i>"]:::page
        DETAIL["ui/windows/client_detail_window.py<br/><i>(Client Workspace)</i>"]:::page
        ADMIN["ui/windows/admin_window.py<br/><i>(Admin Management)</i>"]:::page
        DASH["ui/windows/dashboard_window.py<br/><i>(DRS Status Dashboard)</i>"]:::page
    end
    ...
    subgraph Dialogs & Modals
        ...
        FORM_DLG["ui/dialogs/form_type_manager_dialog.py<br/><i>(Filing Type Manager)</i>"]:::dialog
...
graph LR
    ...
    main["main.py"] --> dashboard_window["ui/windows/dashboard_window.py"]
...
graph LR
    ...
    admin_window["ui/windows/admin_window.py"] --> form_type_manager_dialog["ui/dialogs/form_type_manager_dialog.py"]

    dashboard_window["ui/windows/dashboard_window.py"] --> database["database.py"]
```
...
graph LR
    ...
    form_type_manager_dialog["ui/dialogs/form_type_manager_dialog.py"] --> database["database.py"]
...
| [`database.py`](file:///c:/Users/Nex/Downloads/Project%20Sera/APP/database.py) | `SeraDatabase`, `DatabaseError` | `security` | SQLCipher database CRUD, master column layout (MCL), audit logging, backup/restore, Syncthing/peer conflict matching. |
...
| [`ui/windows/search_window.py`](file:///c:/Users/Nex/Downloads/Project%20Sera/APP/ui/windows/search_window.py) | `SearchWindow` | `database`, `masking` | Global client search, quick copy columns, tabular grid, client action shortcuts. |
| [`ui/windows/client_detail_window.py`](file:///c:/Users/Nex/Downloads/Project%20Sera/APP/ui/windows/client_detail_window.py) | `ClientDetailWindow` | `database`, `manual_credentials_dialog` | Full client profile workspace, credentials, filing history, audit records. |
...
| [`ui/windows/dashboard_window.py`](file:///c:/Users/Nex/Downloads/Project%20Sera/APP/ui/windows/dashboard_window.py) | `DashboardWindow` | `database` | DRS (Document Return Status) dashboard grid and compliance status tracking. |
...
### C. Browser Extension Credentials Injection
```
