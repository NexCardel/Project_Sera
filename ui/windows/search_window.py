...
class SearchWindow(QWidget):
    ...
    def _reload_filters(self):
        ...
        self.service_filter.addItem("🕒 Activity: Earliest → Later", "activity_earliest_to_latest")
        self.service_filter.addItem("🕒 Activity: Latest → Earlier", "activity_latest_to_earliest")
